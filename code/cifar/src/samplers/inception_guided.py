...
class InceptionGuidedReverseSDESampler:
    def __init__(
        self,
        *,
        sde,
        ...
        self.sde = sde
        self.ratio_potential = ratio_potential
    ...
    def log_potential(self, score, x_t, t):
        ...
        return self.ratio_potential(x0_hat)
    ...
    def sample(self, model, num_steps, device, return_mean=True, progress=True):
        ...
        if progress:
            iterator = tqdm(iterator, desc="Inception naive guidance sampling", leave=True)
