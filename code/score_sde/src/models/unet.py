...
class SinusoidalTimeEmbedding(nn.Module):
    """Sinusoidal scalar embeddings for diffusion/SDE time conditioning."""
...
class UNet(nn.Module):
    """
    U-Net backbone for time-conditioned diffusion or score models.

    Defaults are set for MNIST-like image generation:
